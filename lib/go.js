...
var users = require('./analyze/users');
var channels = require('./analyze/channels');
var integrations = require('./analyze/integrations');
var messages = require('./analyze/messages');
    	...
    	stats.setUsers(users);
  		...
  		channels.analyze(users,channel_file).done(function() {
	  		...
	  		integrations.analyze(users,channel_file).done(function() {
		    	...
		    	messages.analyze(users,file_list).done(function() {
		    		stats.exportResults();
		    		console.log('\n\n');
		    		//stats.printResults();
		    		console.log('\n\n');
